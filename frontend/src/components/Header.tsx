        ...
        <Link href="/" className="group flex items-center gap-3">
          <div className="logo-container relative">
            ...
            <div className="relative z-10 w-8 h-8">
              ...
              <img src="/icon.svg" alt={t('iconAlt')} className="w-full h-full drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]" />
            </div>
          </div>
          <span className="font-orbitron font-black text-xl tracking-widest bg-linear-to-r from-cyan-400 via-blue-400 to-purple-500 bg-clip-text text-transparent">
            ContextWeaver
          </span>
        </Link>
