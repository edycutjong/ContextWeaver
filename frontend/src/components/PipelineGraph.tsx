...
export default function PipelineGraph({
  ...
  return (
    <div
      ...
      className="w-full h-[350px] border border-slate-700/50 rounded-xl bg-slate-900/50 backdrop-blur-sm overflow-x-auto overflow-y-hidden scroll-smooth"
    >
      <div
        ref={containerRef}
        ...
        {mounted && (
          <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
            ...
            {edges.map((edge, i) => {
              ...
              const nodeWidth = 140;
              const nodeHeight = 50;
              let x1 = sourcePos.x + nodeWidth / 2 + 50;
              let y1 = sourcePos.y + nodeHeight / 2 + 50;
              let x2 = targetPos.x + nodeWidth / 2 + 50;
              let y2 = targetPos.y + nodeHeight / 2 + 50;
