The frontend dashboard for **ContextWeaver**, built with Next.js 16, Framer Motion, and Tailwind CSS v4.

*Targeted for the **FlagOS Open Computing Global Challenge**, jointly hosted by FlagOS Community, BAAI, and CCF ODTC.*

## Features
- **Pipeline Visualization**: Custom Framer Motion nodes mapping the Chunk → Retrieve → Annotate → Merge pipeline.
